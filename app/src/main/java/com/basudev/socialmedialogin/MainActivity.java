...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fb_settings.getString("fb_logged", "").toString().equals("fb_logged")) {
            ...
            startActivity(new Intent(MainActivity.this, GmailUserProfile.class));
            this.finish();
        }
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(@NonNull View view) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://social-media-login.flycricket.io/privacy.html")));
            }
        };
        ...
        ClickableSpan clickableSpan1 = new ClickableSpan() {
            @Override
            public void onClick(@NonNull View view) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://social-media-login.flycricket.io/terms.html")));
            }
        };
